...
\date{Version 1.6\quad 2014/05/31}
\maketitle
...
\begin{itemize}\linespread{1.1}\selectfont
    ...
    \item[v1.6] ------
    \item \hyperref[sec:fontoption]{글꼴 옵션 |[NoEmbed]|가 추가되었다.}
  \end{itemize}
\end{quote}
...
\item[NoEmbed] 폰트를 내장하지 않으므로 결과물의 크기가 대폭 줄어든다.
  하지만 대외적 배포에 적합하지 않음에 유의할 것.\footnote{%
    Adobe Reader에 내장된 폰트를 쓴다면 대외적 배포도 대체로 무난하다.}
