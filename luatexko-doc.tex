...
\setmathhangulfont{Noto Sans CJK KR}[
  ...
  SizeFeatures={
    {Size=-6,  Font=* Medium},
    {Size=6-8, Font=* Regular},
    {Size=8-,  Font=* DemiLight},
  },
]
...
\item[InterLatinCJK] 한글 또는 한자와 Latin문자 사이의 자간을 설정한다.%
    ...
    한글 한자 다음에 라틴 문자가 오는 경우 원래는 줄바꿈이 되지 않지만
    이 옵션을 주면 줄바꿈이 가능해진다.
\begin{verbatim}
  [InterLatinCJK=0.125em]
\end{verbatim}

\item[InterCharacter] 줄바꿈이 허용되는 곳의 자간을 지시한다.%
  \footnote{%
...
v2.0부터는 고문헌 조판에서 한글 한자와 영문자가 붙어 나오더라도 자동으로
