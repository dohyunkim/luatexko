...
\cs_new_nopar:Npn \actualtag #1 #2
{
  ...
  \tag_if_active:TF
  {
    ...
    \tag_mc_begin:n{}
    \SuspendTagging{actualtag/#1}
    #2
    \ResumeTagging{actualtag/#1}
    \tag_mc_end:
    \tag_struct_end:
    \tag_mc_begin_pop:n{}
  }
...
\def\XeTeX{\actualtag{XeTeX}{\hologo{XeTeX}}}
\def\luatexko{\luatex-\logoko}
\def\xetexko{\XeTeX-\logoko}
\def\texlive{\TeX\ Live}
\def\kotex{\actualtag{ko.TeX, phoneme=[ˌkeɪˈəʊtɛx]}{\logoko\kern-.1ex .\kern-.1667em \TeX}}
...
\newenvironment{plaintex}{%
  ...
  \paragraph{\llap{\color{gray}\normalfont plain \TeX\hskip1em}}\hskip-1em
}{
  \par
}
\makeatother
...
\date{Version 5.0\quad 2025/11/10}
\maketitle
