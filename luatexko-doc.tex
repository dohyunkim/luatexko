...
\directlua{
  ...
  fonts.protrusions.setups.notoserifcjkharf = {
    [171]     = { 0.5, 0   }, % «
    [187]     = { 0,   0.5 }, % »
  ...
  fonts.protrusions.setups.notosanscjknode = { % compresspunctuations
    [0x3001]  = { 0, .5 },
    [0x3002]  = { 0, .5 },
    [0xFF0C]  = { 0, .5 },
    [0xFF0E]  = { 0, .5 },
...
\setmainhangulfont{Noto Serif CJK KR}[
  ...
  BoldFont=* Bold,
  InterLatinCJK=.125em,
  Expansion, Protrusion=notoserifcjkharf,
]
