...
\begin{description}
  ...
  \def\plaintexoption#1{{\small\textcolor{gray}{\hologo{plainTeX}:}\,#1}\quad\ignorespaces}
...
\item[Protrusion] %\pkgkwd*{Protrusion}%
  \plaintexoption{|protrusion=default|}
...
\item[Expansion] %\pkgkwd*{Expansion}%
  \plaintexoption{|expansion=default|}
